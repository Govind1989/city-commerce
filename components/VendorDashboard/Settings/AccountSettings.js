...
const AccountSettings = () => {
  return (
    <div className="pt-0 px-0 overflow-y-hidden h-auto mb-8">
      <div className="col-span-8 overflow-hidden rounded-xl bg-white sm:px-4 sm:shadow">
        <div className="pt-1">
          <h1 className="py-2 text-xl font-semibold">Account settings</h1>
        </div>
        <hr className=" " />
        ...
        <p className="py-0 text-xl font-semibold">Password</p>
