      ...
      <Link href={`/elegant-apparel`}>
        <div className="relative flex items-end overflow-hidden rounded-xl">
          ...
          <div className="flex justify-between">
            <div className="absolute bottom-3 left-4 flex rounded-lg bg-white px-2 py-1 shadow-md">
            ...
            <div className="absolute bottom-3 right-4 flex rounded-lg bg-white px-2 py-1 shadow-md">
              <button className="inline-flex items-center ">
                <span className="text-blue-400 ml-1 text-sm">Follow</span>
              </button>
            </div>
          </div>
        </div>
