  ...
  return (
    <div className="flex flex-col md:flex-row py-5 gap-3 md:gap-5 border-b ">
      ...
      <div className="w-full flex flex-col">
        ...
        {/* PRODUCT SUBTITLE */}
        <div className="text-[12px] font-normal text-gray-400  md:w-3/4 flex-wrap">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua.
        </div>
        <div className="flex justify-between items-center">
          <Link href={`/home-service-pro`} className="sm:mt-1 mt-2 ">
        ...
        <div className="mt-3 md:mt-1 flex gap-2 overflow-x-auto max-w-screen custom-scrollbar">
