...
import { foodMenuItems } from "@/data";
import {
  MdOutlineAddHome,
  MdOutlineSkipNext,
...
import MenuCard from "@/components/Common/CardMenu";
...
const Index = () => {
  ...
  const filteredProducts = foodMenuItems.filter((product) =>
    selectedCategory.includes(product.category)
  );
  // Extract unique categories from foodMenuItems
  const categories = [
          ...
          <div className="grid grid-cols-6 gap-2">
            <div className="lg:col-span-2 col-span-6 py-0 md:order-first ">
              <div className="md:p-8  rounded-xl">
                <div className="">
                  <h1 className="text-sm font-bold text-gray-400 ">#Foods</h1>
          ...
          <div className="flex sm:flex-row flex-col sm:pt-8  md:pb-4">
                  ...
                  <div className="block border-b border-gray-300  pb-2 ">
                    ...
                    <div className="mt-2 flex flex-row  md:flex-col md:overflow-hidden overflow-scroll gap-2 md:gap-2  custom-scrollbar">
                      {categories.map((category, index) => (
                        <label
                          key={index}
                          className="flex items-center whitespace-nowrap text-heading text-sm cursor-pointer"
                        >
                          <input
                            type="checkbox"
                            className="form-checkbox border-gray-300 rounded cursor-pointer transition duration-500 ease-in-out  checked:bg-white checked:border-gray-300 checked:text-heading checked:hover:bg-heading checked:focus:bg-heading active"
                            name={category}
                            value={category}
                            onChange={(e) => handleCategoryChange(e, category)}
                            checked={selectedCategory.includes(category)}
                          />
                          <span className="ml-2 sm:ml-4 text-gray-600">
                            {category}
                          </span>
                        </label>
                      ))}
            ...
            <div className="w-full sm:px-4 px-0 sm:py-0">
              ...
              <div className="w-full py-0 relative pb-0 sm:mb-4">
                <div className="columns-1 md:columns-1 xl:columns-2 gap-2">
            ...
            <div id="store" className="w-full  top-0  sm:py-1">
              <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 sm:px-2 py-3">
                ...
                <div className="flex gap-2 items-center justify-center">
                  ...
                  <CountDownTimer Duration="HappyHourStart" />
                </div>
              </div>
              <ul
