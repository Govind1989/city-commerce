                ...
                <div className="pt-1">
                  <div className="block   pb-2 ">
                    ...
                    <div class="flex justify-start text-xs font-semibold text-gray-600 gap-2 flex-wrap">
                      ...
                      <span class="bg-gray-100 rounded-full px-3 py-1 "></span>
                      <span class="bg-gray-100 rounded-full px-3 py-1 ">
                        #Kitchen Pipes Plumbing
                      </span>
                      <span class="bg-gray-100 rounded-full px-3 py-1 ">
                        #TV Repair
                      </span>
                ...
                <form className="sm:px-6 flex w-full items-center">
                  <div className="relative w-full">
                    ...
                    <input
                      ...
                      placeholder='"#Office Cleaning", "#A/C Installation and Repair", "#Kitchen Plumbing Issues" . . .'
                    />
                  </div>
                  <button
                    type="submit"
